        ...
        <ul className="ml-auto flex flex-row space-x-4 text-lg font-bold text-black ">
          ...
          <Link href="/">
            <svg width="36" height="30" viewBox="0 0 66 63" fill="none" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer">
              <path d="M33 31.5586C36.6451 31.5586 39.6 28.437 39.6 24.5864C39.6 20.7357 36.6451 17.6141 33 17.6141C29.3549 17.6141 26.4 20.7357 26.4 24.5864C26.4 28.437 29.3549 31.5586 33 31.5586Z" fill="black" />
              <path
          ...
          {/* svg keranjang */}
          <Link href="/">
            <svg width="36" height="30" viewBox="0 0 71 57" fill="none" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer">
              <path
          ...
          {/* svg logout */}
          <Link href="/">
            <svg width="36" height="30" viewBox="0 0 36 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer">
              <path
