      ...
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        <div>
            ...
            <div className="md:py-8">
              <form className=" flex flex-col">
                ...
                <div className="mb-4">
                  ...
                  <input type="number" className="form-input h-8 w-1/2 rounded" placeholder="Stoke" />
                </div>
              </form>
            </div>
            {/* content - end */}
          ...
          <div className="mb-10 flex justify-between">
            <button className="relative mb-3 mt-16 rounded-lg bg-red-600 px-8 py-3 text-center text-sm font-semibold text-black hover:bg-red-500 focus-visible:ring active:text-gray-700">Delete Product</button>
            <div className="mt-16">
              ...
              <a href="#" className="mr-96 m-3 rounded-lg bg-white border border-gray-400 px-8 py-3 text-center text-sm font-semibold text-black hover:bg-gray-400 focus-visible:ring active:text-gray-700">
                Cancel
              </a>
            </div>
          </div>
