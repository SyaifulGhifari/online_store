        ...
        <div className='mx-auto max-w-screen-2xl px-4 md:px-8'>
          <div className='mb-10 md:mb-16'>
            ...
            <p className='mx-auto max-w-screen-md text-center text-gray-500 md:text-lg'>
              Ini adalah website Scarva tempat di mana anda bisa melihat dan
              memilih fashion di sini menyediakan Hodie, baju dan kemeja yang
              anda sukai jadi silahkan pilh dan kami akan menyimpannya untuk
              anda.
            </p>
          </div>
